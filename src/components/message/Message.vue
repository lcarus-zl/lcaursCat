<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>留言墙管理</el-breadcrumb-item>
    ...
    <el-card>
      ...
      >
        ...
        <el-table-column label="作者" prop="messageAuthor"> </el-table-column>
      ...
      >
        ...
        >
          <el-form-item label="作者">
            <el-input v-model="showForm.messageAuthor" disabled></el-input>
          </el-form-item>
          <el-form-item label="内容">
            <el-input
              type="textarea"
              v-model="showForm.messageContent"
              disabled
            ></el-input>
          </el-form-item>
        </el-form>
...
export default {
  ...
  methods: {
    async getMessageList() {
      ...
      const { data: data } = await this.$http.get("message/list", {
        params: {
      ...
      console.log(data);
      if (data.code == "200") {
        this.messagelist = data.info.list;
    ...
    async seekUserList() {
      ...
      const { data: data } = await this.$http.get("message/listByMessageName", {
        params: {
          messageAuthor: this.seekvalue,
          pageNum: "1",
          pageRow: "10",
        },
      });
    ...
    editUserInfo() {
      this.$refs.editFormRef.validate(async (valid) => {
        ...
        // 发起修改用户信息请求
        let req = {
          messageAuthor: this.editForm.messageAuthor,
          messageContent: this.editForm.messageContent,
    ...
    async deleteUser() {
      ...
      const { data: data } = await this.$http.post(
        ...
        {
          messageId: this.deletecheckedUsers,
          deleteStatus: "2",
        }
      );
      console.log(data);
      ...
      this.$confirm("是否删除该留言, 是否继续?", "提示", {
        ...
        .then(async () => {
          const { data: data } = await this.$http.post(
            "message/updateMessage",
            {
              messageAuthor: item.messageAuthor,
